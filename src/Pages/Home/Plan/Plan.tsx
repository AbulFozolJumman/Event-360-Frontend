      ...
      <section>
        ...
        <div className="flex justify-center gap-[35px] top-[-200px] relative">
          <div className="max-w-[370px] shadow-md card pt-[44px] pb-6 px-[51px] rounded-xl bg-white">
            ...
            <button className="w-full btn bg-[#5A01CB] mt-[130px] rounded-md py-4 text-white hover:bg-white hover:text-[#5A01CB] font-bold">
              Get this package
            </button>
          </div>
          <div className="max-w-[370px] shadow-md card pt-[44px] pb-6 px-[51px] rounded-xl bg-white">
            ...
            <button className="w-full btn bg-[#5A01CB] mt-[90px] rounded-md py-4 text-white hover:bg-white hover:text-[#5A01CB] font-bold">
              Get this package
            </button>
          </div>
          <div className="max-w-[370px] shadow-md card pt-[44px] pb-6 px-[51px] rounded-xl bg-white">
            ...
            <button className="w-full btn bg-[#5A01CB] mt-12 rounded-md py-4 text-white hover:bg-white hover:text-[#5A01CB] font-bold">
              Get this package
            </button>
          </div>
        </div>
